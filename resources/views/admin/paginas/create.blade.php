...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active"><a href="{{ route('paginas.index') }}">Listar</a></div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('paginas.store') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="titulo" placeholder="Add título da página" class="form-control" value="{{ old('titulo')}}">
                  </div>
