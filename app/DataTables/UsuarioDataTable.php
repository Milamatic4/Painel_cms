    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('Editar', function($query){
                $editar = '<a href="'.route('usuarios.edit', $query->id).'" class="btn btn-primary"><i class="fas fa-edit"></i></a>';

                $deletar = '<a href="'.route('usuarios.destroy', $query->id).'" class="btn btn-primary delete-item ml-2 mr-2" ><i class="fa fa-trash-alt"></i></a>';
            ...
            ->addColumn('capa', function($query){
                if($query->capa != null){
                    $capa = '<img src="'.asset('storage/'.$query->capa).'" style="width:30%" height="auto;">';
                    
                }else{
                $capa = '<img src="'.asset('backend/assets/img/avatar/avatar-1.png').' }}" style="width:30%" height="auto";">';
                }
