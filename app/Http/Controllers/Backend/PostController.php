...
class PostController extends Controller
{
    ...
    {
        $categorias = Categoria::where('tipo', 'categoriaNoticiaAdmin')->get();
    ...
    public function store(Request $request)
    {
        ...
        $postImg = $this->enviaImagemUnica($request, 'capa', 'posts');
    ...
    public function edit(string $id)
    {
        ...
        $categorias = Categoria::where('tipo', 'categoriaNoticiaAdmin')->get();
        return view('admin.posts.edit', compact('categorias', 'post'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $postImg = $this->atualizaImagemUnica($request, 'capa', 'posts', $post->capa);
