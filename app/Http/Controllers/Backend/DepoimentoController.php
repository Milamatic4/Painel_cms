...
use App\DataTables\DepoimentoDataTable;
...
class DepoimentoController extends Controller
{
     ...
     */
    public function index(DepoimentoDataTable $dataTable)
    {
        return $dataTable->render('admin.depoimentos.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $postImg = $this->enviaImagemUnica($request, 'capa', 'depoimento');
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.depoimentos.edit', compact('post'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $postImg = $this->atualizaImagemUnica($request, 'capa', 'depoimento', $post->capa);
